        ...
        <div class="payment">
          ...
          <div class="container">
            <div class="col p-0">
              ...
              <div class="row">
                <h5>電話</h5><input type="text" class="form-control" placeholder="0912345678" aria-label="Username"
                  aria-describedby="basic-addon1">
              </div>
              <div class="row">
              ...
              <div class="col p-0">
                <div class="row p-0">
                  <div class="col-6 p-0"><input type="text" class="form-control" placeholder="城市" aria-label="Username"
                ...
                <div class="row py-1"><input type="text" class="form-control" placeholder="地址" aria-label="Username"
                    aria-describedby="basic-addon1"></div>
              </div>
              <hr>
