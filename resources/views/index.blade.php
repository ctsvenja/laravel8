...
<main>
    ...
    <section class="overview">
      <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container" >
          ...
          <div class="deco-bar mx-auto" style="width:65px;height:4px;background-color:#6366f1;border-radius:2px;margin-top:10px"></div>
        </div>
      </div>
    ...
    <section class="grid" >
      ...
      <div class="container ">
        <div class="row ">
          <div class="col-6">
            <div class="row">
              <div class="col-6"><img class="img-fluid mb-4" src="https://placeholder.pics/svg/285X170" alt=""></div>
              <div class="col-6"><img class="img-fluid mb-4" src="https://placeholder.pics/svg/285X170" alt=""></div>
          ...
          <div class="col-6">
            <div class="row">
              <div class="col-12"><img class="img-fluid mb-4" src="https://placeholder.pics/svg/570X342" alt=""></div>
    ...
    <section class="container price">
      <div>
        ...
        <p class="text-center">Banh mi cornhole echo park skateboard authentic crucifix neutra tilde lyft biodiesel artisan direct trade
    ...
    <section class="container product">
      <div class="container">
        <div class="row">
          ...
          <div class="bar" style="width:65px;height:4px;background-color:#6366f1;border-radius:2px;margin-top:10px"></div>
          ...
          <div>
            <div class="property d-flex">
              <div class="color d-flex ">
                ...
                <div class="rounded-circle"></div>
                <div class="rounded-circle"
                  style="border:2px solid lightgray;width:24px;height:24px;background-color:rgb(55,65,81)"></div>
                <div class="rounded-circle"></div>
                <div class="rounded-circle"></div>
                <div class="rounded-circle"
    ...
    <section class="map container-fluid px-0 position-relative">
      ...
      <div class="card position-absolute d-felx justify-content-center " style="width: 25rem;">
        <form action="/store" method="POST" class="mx-auto">
          @csrf
        
          <div class="card-body">
            <h5 class="card-title">聯絡我們 Contact Us</h5>             
